...
class ComplexOptionType1 : public ::google::protobuf::Message {
 public:
  ...
  inline int foo4_size() const;
  inline void clear_foo4();
  static const int kFoo4FieldNumber = 4;
  inline ::google::protobuf::int32 foo4(int index) const;
  inline void set_foo4(int index, ::google::protobuf::int32 value);
  inline void add_foo4(::google::protobuf::int32 value);
...
class ComplexOptionType2 : public ::google::protobuf::Message {
 public:
  ...
  inline int barney_size() const;
  inline void clear_barney();
  static const int kBarneyFieldNumber = 4;
  inline const ::protobuf_unittest::ComplexOptionType2_ComplexOptionType4& barney(int index) const;
  inline ::protobuf_unittest::ComplexOptionType2_ComplexOptionType4* mutable_barney(int index);
  inline ::protobuf_unittest::ComplexOptionType2_ComplexOptionType4* add_barney();
